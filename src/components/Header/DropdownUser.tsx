  ...
  return (
    <ClickOutside onClick={() => setDropdownOpen(false)} className=" relative">
      <button
        ...
        className="bg flex items-center gap-4"
      >
        ...
        <span className="bg flex items-center gap-2 font-medium text-dark dark:text-dark-6">
          <span className="hidden lg:block">{user?.nama || "User"}</span>
          <span className="hidden lg:block">
            {user?.golongan_darah || "User"}
          </span>
          <svg
        ...
        >
          ...
          <ul className="flex flex-col gap-1 border-y-[0.5px] border-stroke p-2.5 dark:border-dark-3">
            ...
            <li className="ProfileMenu">
              <Link href="/profileUser" className="">
